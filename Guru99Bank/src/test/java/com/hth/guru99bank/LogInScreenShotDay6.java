...
public class LogInScreenShotDay6 {
	...
	public Object[][] getData() throws IOException {
		...
		ExcelUtils excel = new ExcelUtils(projectPath + "/Data/Data.xlsx", "Sheet1");
	...
	public static void verifyLogIn(String userName, String userPassword) throws IOException {
		...
		try {
			...
			FileUtils.copyFile(screenShotFile, new File(projectPath + "/data/LoginSuccess.png"));
		}
	}
